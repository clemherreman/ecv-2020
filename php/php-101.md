...
Q1: Ecrire une fonction arrayMax, qui prend en paramètre un array de nombre, et retourne le plus grand.
...
Q2: Ecrire une fonction puissance, qui prend en paramètre 2 nombres A et B, et retourne A^B.
...
Q3: Ecrire une fonction lettreCommunes, qui prend en paramètre 2 strings, et retourne la liste des lettres en commun dans les 2 strings.
...
Q4: Ecrire une fonction moyenne, qui prends en paramètre un array de nombre, et retourne la moyenne.
...
Q5: Ecrire une fonction triangle, qui prend en apramètre un entier, et qui retourne cette string pour `5` par exemple
...
Q1: Ecrire un formulaire permettant de saisir son nom, son email et un message. Une fois ce formulaire soumis, les informations sont écrites dans une ligne d'un fichier `contacts.txt` se trouvant dans `/tmp`.
